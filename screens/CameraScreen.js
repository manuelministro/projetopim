...
import { Alert, StyleSheet, Text, View, TouchableOpacity, Slider, Vibration } from 'react-native';
  ...
  onBarCodeRead = (qrCode) => {
    if (!this.state.qrCode) {
      ...
      Alert.alert('Alert',
        ...
        [
          {text: 'OK', onPress: () => this.setState({ qrCode: null })}
        ]
      );
    }
  }
    ...
    return (
      <Camera
        ...
        <View
          ...
          <TouchableOpacity
            style={[styles.flipButton, styles.picButton, { flex: 0.55, alignSelf: 'flex-end' }]}
